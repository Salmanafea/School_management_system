...
{
    use WithFileUploads;
    public $currentStep = 1,$id, $successMessage = '',$updateMode=false,$catchError,$photos,$show_table=true,$Parent_id,$showEditForm,
            ...
            if (!empty($this->photos)){
                foreach ($this->photos as $photo) {
                    ...
                    ParentAttachment::create([
                        ...
                        'parent_id' => My_Parent::latest()->first()->id, //اخر id دخل في ولي الامر
                    ]);
                }
            }
