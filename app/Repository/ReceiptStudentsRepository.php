...
class ReceiptStudentsRepository implements ReceiptStudentsRepositoryInterface
{
    public function index(){
        ...
        return view('pages.Students.Receipt.index',compact('receipt_students'));
    ...
    public function edit($id){
        ...
        return view('pages.Students.Receipt.edit',compact('receipt_student'));
