        ...
        <li>
         ...
         <li>
            ...
            <ul id="Accounts-menu" class="collapse" data-parent="#sidebarnav">
                ...
                <li> <a href="{{route('Payment_students.index')}}"> {{trans('main_trans.Bills_of_exchange')}}</a> </li>
            </ul>
        </li>
    ...
    <li>
         ...
         <!-- Quizzes-->
                    <li>
                        ...
                        <ul id="Exams-icon" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('quizzes.index')}}"> {{trans('main_trans.List_of_tests')}}</a> </li>
                            <li> <a href="{{route('questions.index')}}"> {{trans('main_trans.List_of_questions')}}</a> </li>
                        </ul>
                    </li>
        ...
        <li>
            ...
            <ul id="library-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('library.index')}}">{{trans('main_trans.Book_list')}} </a> </li>
       ...
       <li>
        ...
        <ul id="Onlineclasses-icon" class="collapse" data-parent="#sidebarnav">
            <li> <a href="{{route('online_classes.index')}}">{{trans('Students_trans.Online_classes_with_Zoom')}}</a> </li>
