...
@section('css')
    @toastr_css
@section('title')
   {{trans('Students_trans.receipt_exchange')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
{{trans('Students_trans.receipt_exchange')}}<label style="color: red">{{$payment_student->student->name}}</label>
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input  class="form-control" name="Debit" type="number"value="{{$payment_student->amount}}" >
