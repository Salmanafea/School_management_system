...
@section('css')
    @toastr_css
@section('title')
    {{trans('main_trans.Add_a_new_offline_share')}}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{route('online_zoom_classes.store')}}" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label >{{trans('Students_trans.Class_date_and_time')}}   : <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>{{trans('Students_trans.The_duration_of_the_class_in_minutes')}}   : <span class="text-danger">*</span></label>
