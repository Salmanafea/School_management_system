...
@section('css')
    @toastr_css
@section('title')
{{trans('Students_trans.Amending_a_receipt_voucher')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
{{trans('Students_trans.Amending_a_receipt_voucher')}}: <label style="color: red">{{$receipt_student->student->name}}</label>
@stop
<!-- breadcrumb -->
@endsection
@section('content')
