...
@section('css')
    @toastr_css
@section('title')
{{trans('main_trans.Edit_Test')}}  {{$quizz->name}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                        ...
                        <div class="col-md-12">
                            ...
                            <form action="{{route('quizzes.update','test')}}" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        <label for="title">{{trans('main_trans.test_name_ar')}}</label>
                                    ...
                                    <div class="col">
                                        <label for="title">{{trans('main_trans.test_name_en')}}</label>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="subject_id">
                                                <option selected disabled>{{trans('main_trans.Select_the_academic_subject')}}  ...</option>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="Grade_id">{{trans('main_trans.The_name_of_the_teacher')}}  : <span class="text-danger">*</span></label>
                                            <select class="custom-select mr-sm-2" name="teacher_id">
                                                <option selected disabled>{{trans('main_trans.Select_the_teacher_name')}}  ...</option>
